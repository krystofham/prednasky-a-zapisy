...
1) Fressnelovy integrály
	1) Potřeba znalostí níže
2) Gaussův vzorec
	1) Potřeba kontextu (dole)
3) Hlavolamy a matematika
4) Jaderná fúze a výzkum
5) Stopařův průvodsce exoplanetami
6) Dynamika hmotného bodu
# Rozpracované podle priorit
...
8) Posloupnosti a řady
	1) Taylorovy řady
	2) https://cs.khanacademy.org/math/posloupnosti-a-rady
9) **Kmitání**
10) Pokročilé integrály
	1) Integrály https://ksp.mff.cuni.cz/encyklopedie/integraly/ 
...
1) Astrofyzika
	1) Exoplanety
2) Jak zefektivnit jadernou elektrárnu - soč?
3) Mechanika
4) Termodynamika
...
11) Atomová a jaderná fyzika
12) Jaderná fúze 
13) Základní věci
	1) Higgsův boson, positron, elektron ap.
14) Částicová fyzika
15) Kombinatorika
	- Bayesova věta
	- Stars:Bars https://www.youtube.com/watch?v=40HxI6Uc00Q
	- Faktoriály /skomam
	-  Pravděpodobnost https://ksp.mff.cuni.cz/encyklopedie/pravdepodobnost/
	- https://cs.khanacademy.org/math/pravdepodobnost-a-kombinatorika
	- https://www.youtube.com/watch?v=VJkvPTY6kZw
16) Algoritmy
	1) https://www.youtube.com/watch?v=SmyPTnlqhlk
	2) Monte Carlo
	3) Hledání cesty - algoritmy Hamilton a greedy 
	4)  Rozděl a panuj https://ksp.mff.cuni.cz/encyklopedie/rozdel-a-panuj/ 
	5) Haldy, heapsort a Dijkstrův algoritmus https://ksp.mff.cuni.cz/encyklopedie/halda-a-cesty/
	6) Intervalové stromy https://ksp.mff.cuni.cz/encyklopedie/intervalove-stromy/ 
	7) https://www.youtube.com/watch?v=xX5iOYCJmBI&list=PLZPZq0r_RZON1eaqfafTnEexRzuHbfZX8
	8) Optional: https://www.youtube.com/watch?v=8hly31xKli0
17) Teorie čísel
	1) Kongruence
	2) Kvadratické zbytky
	3) Diofantické rovnice
	4)  Teorie čísel https://ksp.mff.cuni.cz/encyklopedie/teorie-cisel/
18) Analýza
	1) Vektorová analýza
		1) Gaussův vzorec
			1) Maxwellovy rovnice
	2) Komplexní analýza
19) Pravděpodobnostní modely
	1) Markovovy řetězce
		1) https://www.youtube.com/watch?v=KZeIEiBrT_w
	2) Monte Carlo a algortimy
20) Kryptografie (RSA a Elliptic Curves)
21) Kvantová mechanika
	1) https://prase.cz/library/KvantovePocitaceRS/KvantovePocitaceRS.pdf 
	2) https://prase.cz/library/KvantovaMechanikaKF/KvantovaMechanikaKF.pdf
	3) https://prase.cz/library/KvantovePocitaceMF/KvantovePocitaceMF.pdf 
	4) https://www.youtube.com/watch?v=RQWpF2Gb-gU 
	5) https://www.youtube.com/watch?v=BHEhxPuMmQI 
	6) Groverův algoritmu https://www.youtube.com/watch?v=Dlsa9EBKDGI
	7) https://www.youtube.com/watch?v=kgSVkVNxXyU
22)  Dynamic programming
	1) https://www.youtube.com/watch?v=66hDgWottdA 
	2) https://ksp.mff.cuni.cz/encyklopedie/dynamicke-programovani/ 
23) Komplexní čísla
	1) https://cs.khanacademy.org/math/komplexni-cisla
24) Analytická geometrie
	1) https://cs.khanacademy.org/math/analyticka-geometrie

# 2) Hierarchický strom (logická návaznost)
...
- Proč π
- Goniometrické identity, Eulerův vzorec, Komplexní čísla
- Posloupnosti a řady    
    - Taylorovy řady
### B) Analýza
- Integrály (základ)
...
### C) Lineární algebra
- Matice
- Lineární algebra (playlist) 
- Hilbertův prostor
### D) Diskrétní matematika
- Kombinatorika (Bayes, Stars and Bars, faktoriály)    
- Teorie čísel (kongruence, Diofantické rovnice, kvadratické zbytky)
- Eulerovy tahy
- Fraktální geometrie
### E) Pravděpodobnost
- Pravděpodobnost
...
- Kmitání
- Teorie chaosu
### B) Elektřina a magnetismus
- Gaussův vzorec
- Maxwellovy rovnice

### C) Optika
- Geometrická vs. vlnová optika
- Zrcadla
...
### F) Kvantová fyzika
- Hilbertův prostor (návaznost z matematiky)
- Kvantová mechanika
- Groverův algoritmus
### G) Jaderná a částicová fyzika
- Radioaktivní rozpad
- Jaderná fúze
- Antihmota
- Hadronový urychlovač částic (např. výzkum v CERN)
- Higgsův boson
...
# 3) Klíčové mezery (doporučuji doplnit)

Matematika:

- Limity a derivace (nutné před integrály a diferenciálními rovnicemi)
- Vlastní čísla a vektory (před Hilbertovým prostorem)
- Diferenciální počet funkcí více proměnných

Fyzika:

- Zákony zachování (energie, hybnost)
- Lagrangeova mechanika
- Základy elektromagnetického pole

Informatika:
- Časová složitost (Big-O notace)
- Rekurze (před dynamic programming)