---
slug: Souhlásky-—-ch,-sch,-st,-sp,-ß-NJ
...
|---|---|---|---|
|sch|**š** (vždy, bez výjimky)|**Sch**ule|škola|
...
|---|---|---|---|---|
|**Začátek slova/slabiky**|sp|**šp**|**Sp**ort|sport|
|**Začátek slova/slabiky**|st|**št**|**St**adt|město|
|**Uprostřed / konec slova**|sp|sp|be**sp**rechen|projednat|
|**Uprostřed / konec slova**|st|st|Fe**st**|svátek|
...
|---|---|---|---|---|
|po **a, o, u, au**|**[x]** – hrdelní „ch"|jako v „Bach" nebo „chrapot"|Bu**ch**, Na**ch**t|kniha, noc|
|po **e, i, ä, ö, ü, ei, eu**|**[ç]** – měkké „ch"|jako šepot „hj" nebo „ch" v „chyba" jemněji|i**ch**, Mil**ch**|já, mléko|
|na začátku slova|**[ç]** – měkké „ch"|stejné jako výše|**Ch**emie|chemie|
|v kombinaci -chs-|**ks**|čte se jako „ks"|se**chs**|šest|
|v kombinaci -ck-|**k**|čte se jako „k"|Zu**ck**er|cukr|
...
|---|---|---|---|---|
|ß|**ss**|po dlouhé samohlásce nebo dvojhlásce|Stra**ß**e, hei**ß**|ulice, horký|
|ss|**ss**|po krátké samohlásce|Wa**ss**er, e**ss**en|voda, jíst|
...
1. Wa**ss**er _(krátká samohláska → ss)_
2. Stra**ß**e _(dlouhá samohláska → ß)_
3. hei**ß**t _(dvojhláska ei → ß)_
4. e**ss**e _(krátká samohláska → ss)_
5. gro**ß** _(dlouhá samohláska → ß)_
...
|**SP uprostřed čtou jako „šp"**|be„šp"rechen|be**sp**rechen|Šp jen na začátku slova!|
...
1. Die __ule ist gro__. (škola / velká)
2. Ich __reche Deut__. (mluvím / německy)
...
1. Die **Sch**ule ist gro**ß**.
2. Ich **sp**reche Deut**sch**.
3. Das Bu**ch** liegt auf dem Ti**sch**.
4. Die Stra**ß**e ist lang.
5. Es ist no**ch** nicht zu sp**ä**t.
...
|---|---|---|
|**sch**|vždy **š**|**Sch**ule (škola)|
|**sp** (začátek)|**šp**|**Sp**ort|
|**st** (začátek)|**št**|**St**adt (město)|
|**ch** po a/o/u/au|**hrdelní** [x]|Bu**ch** (kniha)|
|**ch** po e/i/ä/ö/ü|**měkké** [ç]|i**ch** (já)|
|**ß**|vždy **ss**|Stra**ß**e (ulice)|
|**chs**|**ks**|se**chs** (šest)|
...
_Studijní materiál vytvořen pro A0 | Téma 4: Souhlásky ch, sch, st, sp, ß_